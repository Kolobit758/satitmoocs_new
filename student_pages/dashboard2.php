...
<head>
    ...
    <style>
        ...
        .web-header {
            ...
            /* background: url("https://cdn.dribbble.com/userupload/20614941/file/original-00317bedf76f88f03e9c25826beb4ad7.gif"); */
        ...
        .course-head {
            /* background: url("https://i.pinimg.com/originals/a0/84/65/a08465fcb5cb830adfcbcc3ae9ea1116.gif"); */
            background: url("https://i.pinimg.com/originals/a0/84/65/a08465fcb5cb830adfcbcc3ae9ea1116.gif");
            background-size: cover;
            background-position: center;
            background-attachment: fixed;
...
<body>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="mt-5 course-head" style="text-align: center;">
                    ...
                    <?php foreach ($courses_data as $course_data) : ?>
                        <div class="col-3 course_box">
                            <a href="course.php?id=<?= $course_data['course_id'] ?>" class="course_box" style="text-decoration: none; color: inherit;">
                                ...
                                <?php endif; ?>
                                <h4 class="d-flex justify-content-center align-items-center" style="width: 100%; height:100px"><?= $course_data['course_name'] ?></h4>
                            </a>
